...
## First source for documentation
...
$ echo "export ITK_GLOBAL_DEFAULT_NUMBER_OF_THREADS=1" >> ~/.profile
$ source ~/.profile
```

## Some cmake considerations
...
## Try calling the ```KellyKapowski``` short help menu.
...
## ```antsRegistration``` long help menu.
